!function () {
    ...
    Maker.prototype.makeAbbs = function makeAbbs(columns, filter) {
        ...
        columns.forEach(function(column) {
            ...
            var candidateAbb = this.makeAbb(column);
            while (this.abbExist(candidateAbb, abbs)) {
                candidateAbb = this.renameAbb(candidateAbb);
            }
    ...
    Maker.prototype.createServerFiles = function createServerFiles(orms, dir) {
        ...
        orms.forEach(function(orm) {
            // pk
            this.createServerPKFile(orm, dir);
            this.createServerPKStoreFile(orm, dir);
            // model
            this.createServerModelFile(orm, dir);
            this.createServerModelStoreFile(orm, dir);
            // list
            if (orm.list) {
                this.createServerListFile(orm, dir);
                this.createServerListStoreFile(orm, dir);
            }
        }.bind(this));
    };
    ...
    Maker.prototype.createClientFiles = function createClientFiles(orms, dir) {
        ...
        orms.forEach(function(orm) {
            // pk
            this.createClientPKFile(orm, dir);
            ...
            // list
            if (orm.list) {
                this.createClientListFile(orm, dir);
