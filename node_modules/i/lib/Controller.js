...
Controller.prototype.process = function(ctrl, params, cb) {
...
Controller.prototype.validate = function(params, paramConfig) {
    for (var name in paramConfig) {
        this.validateEach(params[name], paramConfig[name]);
    }
};

Controller.prototype.validateEach = function(value, type) {
